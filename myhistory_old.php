...
<div class="container">	
	...
	<button id='getTaxReport' type="button" class="btn btn-success btn-block" style="display:block">Click for 2015 Tax Report</button> 
	<BR />
...
$(document).ready(function () {
	...
	$("#getTaxReport").click(function() {
		...
		window.location.href="http://secure.northlandchurch.net:8080/ReportAppSimple/viewReport.do?reportname=TaxForm&usercid=" + cid;
	});
