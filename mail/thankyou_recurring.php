...
*/
	...
	$message->setBody(returnHtmlBody($firstname, $lastname, $amount, $frequency, $nextdate), 'text/html');

	// Add alternative parts with addPart()
	$message->addPart(returnTextBody($firstname, $lastname, $amount, $frequency, $nextdate), 'text/plain');
...
function returnHtmlBody($firstname, $lastname, $amount, $frequency, $nextdate)
{
	$htmlBody = "						
		...
		<br><br>
		 ...
		 <br><br>
			...
			Your " . $frequency . " gift of $" . $amount . " will process beginning " . $nextdate . ".<br><br>
...
function returnTextBody($firstname, $lastname, $amount, $frequency, $nextexecdate)
{
	$textBody = "
		Dear " . $firstname . " " . $lastname . ",
		...
		Your " . $frequency . " gift of $" . $amount . " will process beginning " . $nextexecdate . ".
