...
<div class="container" style="display:block">	
	<H2 class="heading-large">SUPPORT SHORT TERM MISSION TRIPS</H2>
	<hr>
...
<!--	<input type="hidden" id="recurringid" name="recurringid" value="0">	-->
	...
	<div class="panel panel-info">
		<div class="panel-heading">
			<H3 class="panel-title">Mission Trip</H3>
		</div>
...
<!--							<option value="Missionary">Support Missionary</option>	-->
				...
				<div class="form-group" id="divcomments">				
					...
					<div class="col-sm-10">
						<textarea id="comments" name="comments" class="form-control" maxlength="200">Support for <?php if(isset($_GET['name'])) { echo $_GET['name'];} ?></textarea>
					</div>
				</div>
...
-->
	<div id="result" class="alert alert-danger" role="alert" style="display:none">
		<p id="message"></p>
		<a href="./donate.php" id="gobacktogive" class="heading heading-l">Go Back to GIVE</a>
	</div>	
...
/*	
	// Below function is not supported in IE < 12. 
	if ((b_name.includes('cody') && b_name.includes('mcmurrin')) 
		|| (b_name.includes('alina') && b_name.includes('areopagita')) 
		|| (b_name.includes('emily') && b_name.includes('linton')) 
		|| (b_name.includes('bailey') && b_name.includes('mcdonald')) 
		|| (b_name.includes('alex') && b_name.includes('ramos')) 
		|| (b_name.includes('joshua') && b_name.includes('stockton')))
*/		
