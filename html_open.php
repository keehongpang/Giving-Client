...
<header>
	<div class="nav-bar">
		...
		<ul id="second-nav">
			<?php if ($logged_in) : ?>
				<li id="link-respond">
					<span><a href="./myprofile.php">PROFILE</a></span>
				</li>
				<li id="link-resources">
					<span><a href="./mypayment.php">ACCOUNTS</a></span>
				</li>
				<li id="link-connect">
					<span><a href="./givenow.php">GIVE</a></span>
				</li>
				<li id="link-history">
					<span><a href="./myhistory.php">HISTORY</a></span>
				</li>
				<li id="link-about"><span class="navb" style="text-transform:none;color:#DBD2C3;font-weight: bold"><a href="./logout.php">Sign Out</a></span></li>
			<?php else : ?>
				...
				<li id="link-help"><span class="navb" style="text-transform:none;color:#DBD2C3;font-weight: bold"><a href="./donate/givenologin.php">Give Without an Account</a></span></li>
			<?php endif; ?>
			</li>
		</ul>
				...
				<ul class="main-nav">
					<li>
						...
						<?php if ($logged_in) : ?>
							...
							<li><a href="./mypayment.php">Accounts</a></li>
							<li><a href="./givenow.php">Give</a></li>
